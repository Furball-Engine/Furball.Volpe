    ...
    public class Operators
    {
        public static Value Sum(Value rightValue, Value leftValue, Evaluator.Context context)
        {
            return (rightValue, leftValue) switch
            {
                ...
                _ => throw new UndefinedOperationException(
                    "sum", rightValue.GetType(), leftValue.GetType(), context.RootExpression.PositionInText)
            };
        }
        ...
        public static Value Subtract(Value rightValue, Value leftValue, Evaluator.Context context)
        {
            ...
            return (rightValue, leftValue) switch
            {
                ...
                _ => throw new UndefinedOperationException(
                    "subtraction", rightValue.GetType(), leftValue.GetType(), context.RootExpression.PositionInText)
            };
        }
        ...
        public static Value Multiply(Value rightValue, Value leftValue, Evaluator.Context context)
        {
            ...
            {
                if (count < 0)
                    throw new OperatorDomainException(context.RootExpression.PositionInText,
            ...
            return (rightValue, leftValue) switch
            {
                ...
                _ => throw new UndefinedOperationException(
                    "multiplication", rightValue.GetType(), leftValue.GetType(), context.RootExpression.PositionInText)
            };
        }
        ...
        public static Value Divide(Value rightValue, Value leftValue, Evaluator.Context context)
        {
            return (rightValue, leftValue) switch
            {
                ...
                _ => throw new UndefinedOperationException(
                    "division", rightValue.GetType(), leftValue.GetType(), context.RootExpression.PositionInText)
            };
        }
    }
}