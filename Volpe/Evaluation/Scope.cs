...
namespace Volpe.Evaluation
{
    public class Scope
    {
        ...
        public Scope((string name, int parameterCount, Func<Evaluator.Context, Value[], Value> del)[] builtins)
        {
        ...
        public Scope() : this(Array.Empty<(string, int, Func<Evaluator.Context, Value[], Value>)>())
        {
        }
